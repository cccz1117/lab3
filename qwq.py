...
# output_file = "./qwq_generated_results.json"
...
payload = {
    "prompt": prompt,
    "max_tokens": 2056,  # Adjust this depending on how long a response you want
...
if response.status_code == 200:
    ...
    result = response.json()
    with open("qwen_output.txt", "w", encoding="utf-8") as file:
